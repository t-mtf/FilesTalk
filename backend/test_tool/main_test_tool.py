...
def main_synthesize(input_file_name):
    ...
    try:
        ...
        prompts = [
            ...
            {"name": "inflation_type", "value": "What is the inflation type? "},
            {
        ...
        format_and_save_excel(
            df=df_synthesized, output_file_path=output_file_path, sheet_name="Sheet1"
        )
...
def format_comparison_results(input_file_path, sheet_name="Sheet1"):
...
def main():
    ...
    try:
        ...
        if compare_two_results:
            ...
            input_file_name1 = "document_IZ_contracts_fields_dec_2024_v5"
            file_suffix1 = "v5"
            input_file_name2 = "document_IZ_contracts_fields_dec_2024_v6"
            file_suffix2 = "v6"
            ...
            input_file_name = "document_IZ_contracts_fields_dec_2024_v5"  # extension .xlsx is not needed.
            input_suffix = "v5"
